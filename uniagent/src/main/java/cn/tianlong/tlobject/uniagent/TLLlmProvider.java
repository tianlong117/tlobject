 ...
 *
 * 复制自 aiagent.TLLlmProvider，包名改为 uniagent，TLAiAgentParamString → UniAgentParamString。
 *
 * 创建日期：2026/7/4
 * 作者:tianlong
 */
public abstract class TLLlmProvider extends TLBaseModule implements UniAgentParamString {
