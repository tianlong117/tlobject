 ...
 * 支持多会话并发访问，自动裁剪超长历史。
 *
 * 复制自 aiagent.TLAiContext，包名改为 uniagent，TLAiAgentParamString → UniAgentParamString。
 *
 * 创建日期：2026/7/4
 * 作者:tianlong
 */
public class TLAiContext extends TLBaseModule implements UniAgentParamString {
