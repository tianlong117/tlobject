...
The complete manual (≈1,400 lines, in Chinese) lives in **`aiagent/README.zh.md`**: architecture deep-dive, all core classes with fields/actions/algorithms, message flows, XML reference, usage examples, extension development, and the new-feature modules (MCP, Evals, unit tests, HITL, sessions).
